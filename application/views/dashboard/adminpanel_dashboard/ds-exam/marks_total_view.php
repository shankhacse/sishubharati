  ...
  .error-border{
    ...
    <section class="content">
            ...
            <div class="box-body">
                ...
                <?php
              $attr = array("id"=>"MarksTotalForm","name"=>"MarksTotalForm");
              echo form_open('',$attr); ?>
              <div class="row">
            ...
            <p id="clssubcreatmsg" class="form_error"></p>
              ...
              <button type="submit" class="btn btn-primary formBtn" >View Total Marks</button>
              <button type="button" class="btn btn-success formBtn" id="specialmarks" >Add Special Marks</button>
              </div>
                 </div>
