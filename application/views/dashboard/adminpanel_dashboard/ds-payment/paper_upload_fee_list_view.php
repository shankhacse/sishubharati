...
<link rel="stylesheet" href="<?php echo base_url();?>application/assets/css/admin_style.css" />     
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Exam Paper Upload Fee </li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="box-header">
              <h3 class="box-title">Students List for Exam Paper Upload Fee</h3>
            ...
            <div class="box-body">
                ...
                <?php
              $attr = array("id"=>"PaperUploadPaymentForm","name"=>"PaperUploadPaymentForm");
              echo form_open('',$attr); ?>
              <div class="row">
           ...
           <p style="text-align:center;color:#055E87;letter-spacing:1px;">Please wait loading...</p>
            ...
            <section id="loadPaperUploadFeeStudentList"> 
    ...
    <!-- /.content -->
      ...
      <!-- Modal -->
  <div class="modal fade bd-example-modal-lg" id="makepaymentuploadpaper_info" role="dialog" data-backdrop="static" data-keyboard="false">
