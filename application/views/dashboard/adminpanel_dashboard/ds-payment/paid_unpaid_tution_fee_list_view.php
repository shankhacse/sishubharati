...
<link rel="stylesheet" href="<?php echo base_url();?>application/assets/css/admin_style.css" />     
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Students List for Paid/Unpaid Tution Fee </li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="box-header">
              <h3 class="box-title">Students List for Paid/Unpaid Tution Fee</h3>
            ...
            <div class="box-body">
                ...
                <?php
              $attr = array("id"=>"paidUnpaidTutionFeeForm","name"=>"paidUnpaidTutionFeeForm");
              echo form_open('',$attr); ?>
              <div class="row">
            ...
            <div class="col-md-4">
                    ...
                    <option value="<?php echo $value->id; ?>"><?php echo $value->name ; ?></option>
                     ...
                     <div class="row">
            <div class="col-md-4 "><label for="classList" class="searchby"> Month </label> </div>
            <div class="col-md-4">
                      <div class="form-group">
           ...
           <p style="text-align:center;color:#055E87;letter-spacing:1px;">Please wait loading...</p>
            ...
            <section id="loadPaidUnpaidStudentList"> 
