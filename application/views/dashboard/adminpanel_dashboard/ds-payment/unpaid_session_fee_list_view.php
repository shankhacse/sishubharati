...
<link rel="stylesheet" href="<?php echo base_url();?>application/assets/css/admin_style.css" />     
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Students List of Unpaid Session Fee </li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="box-header">
              <h3 class="box-title">Students List of Unpaid Session Fee</h3>
            ...
            <div class="box-body">
                ...
                <?php
              $attr = array("id"=>"UnpaidSesListForm","name"=>"UnpaidSesListForm");
              echo form_open('',$attr); ?>
              <div class="row">
           ...
           <p style="text-align:center;color:#055E87;letter-spacing:1px;">Please wait loading...</p>
            ...
            <section id="loadUnpaidSesStudentList"> 
   ...
   <!-- Modal -->
  <div class="modal fade bd-example-modal-lg" id="ses_makepayment_info" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-md">
      ...
      <button type="button" class="btn-xs bg-green margin"><h4 class="modal-title" id="title_info"></h4></button>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="return redirectSessionFee();">Close</button>
        </div>
      </div>
