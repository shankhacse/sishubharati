   <form class="form-area" name="classnotesForm" id="classnotesForm" enctype="multipart/form-data">
    <input type="hidden" name="classnotesID" id="classnotesID" value="<?php echo $classnoteid;?>" />
   ...
   <div class="box-body" style="min-height: 380px;">
                 <div class="row">
                               ...
                               <div class="col-md-6 col-sm-12 col-xs-12" style="margin-bottom: 10px;text-transform: capitalize;">
                                 <button type="button" class="btn btn-sm btn-danger addDocument">
                                   <span class="glyphicon glyphicon-plus"></span> Add Notes <?php echo ucfirst($classname)?>
                                 </button>
                               </div>
                      </div>      
            ...
            <?php
              ...
              if($mode=="Edit")
              {
                $detailCount = sizeof($classNotesDocumenDtl);
              }
            ...
            ?>
              ...
              <table class="table table-striped table-bordered no-footer" role="grid" aria-describedby="datatable_info" style="<?php echo $style_var; ?>">
                ...
                if($detailCount>0)
                {
                  foreach ($classNotesDocumenDtl as $key => $value) 
                  {
...
<!-- end of Add document-->
            ...
            <p id="marksmsg" class="form_error"></p>
                  ...
                  <div class="btnDiv">
                      <button type="submit" class="btn btn-primary" id="classnotessavebtn" style="width: 100px;">Save</button>
              ...
              <div class="response_msg" id="classnotes_response_msg">