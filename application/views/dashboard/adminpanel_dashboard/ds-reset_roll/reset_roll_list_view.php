<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/resetroll.js"></script> 
<link rel="stylesheet" href="<?php echo base_url();?>application/assets/css/admin_style.css" />     
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Reset Class Roll</li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="box-header">
              <h3 class="box-title">Reset Class Roll</h3>
            ...
            <div class="box-body">
                ...
                <?php
              $attr = array("id"=>"ResetRollForm","name"=>"ResetRollForm");
              echo form_open('',$attr); ?>
              <div class="row">
