...
?>
    ...
    <section class="content">
            ...
            <div class="box-header">
              <h3 class="box-title">Attendance Register</h3>
               <a href="<?php echo base_url();?>attendance/addattendance" class="link_tab"><span class="glyphicon glyphicon-Plus"></span> ADD</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">

                <?php
              $attr = array("id"=>"AttendanceRegisterForm","name"=>"AttendanceRegisterForm");
              echo form_open('',$attr); ?>
              <div class="row">
            ...
            <div class="col-md-4">
                 ...
                 <div class="row">
                      <div class="col-md-4 "><label for="classList" class="searchby">Attendance Date </label> </div>
                      <div class="col-md-4">
                                <div class="form-group">
