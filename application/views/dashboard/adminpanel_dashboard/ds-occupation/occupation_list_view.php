<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/classmaster.js"></script>     
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Occupation List</li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="box-header">
              ...
              <a href="<?php echo base_url();?>occupation/addoccupation" class="link_tab"><span class="glyphicon glyphicon-plus"></span> ADD</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table class="table table-bordered table-striped dataTables" style="border-collapse: collapse !important;">
                ...
                <tbody>
              	...
              	<?php 
					...
					<tr>
						<td><?php echo $i++; ?></td>
            <td><?php echo $value->occupation_type; ?></td>
