...
<link rel="stylesheet" href="<?php echo base_url();?>application/assets/css/admin_style.css" />     
    ...
    <section class="content">
            ...
            <div class="box-header">
              <h3 class="box-title">Transfer Certificate of Student</h3>
             <a href="<?php echo base_url();?>studentaction" class="link_tab"><span class="glyphicon glyphicon-list"></span> List</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">

                <?php
              $attr = array("id"=>"TcRequestForm","name"=>"TcRequestForm");
              echo form_open('',$attr); ?>
                <div class="row">
            ...
            <div class="col-md-4">
              ...
              <button type="submit" class="btn btn-primary formBtn">View Student Details</button>
              </div>
                 </div>
             <?php echo form_close(); ?>
