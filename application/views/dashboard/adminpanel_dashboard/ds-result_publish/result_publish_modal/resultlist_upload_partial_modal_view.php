   <form class="form-area" name="resultlistForm" id="resultlistForm" enctype="multipart/form-data">
    <input type="hidden" name="publishID" id="publishID" value="<?php echo $publishid;?>" />
                 ...
                 <div class="row">
                               ...
                               <div class="col-md-6 col-sm-12 col-xs-12" style="margin-bottom: 10px;text-transform: capitalize;">
                                 <button type="button" class="btn btn-sm btn-danger addDocument">
                                   <span class="glyphicon glyphicon-plus"></span> Add Result List <?php echo ucfirst($term)." Term"?>
                                 </button>
                               </div>
                      </div>      
...
<!-- end of Add document-->
            ...
            <p id="marksmsg" class="form_error"></p>
                  ...
                  <div class="btnDiv">
                      <button type="submit" class="btn btn-primary formBtn" id="resultlistsavebtn">Save</button>
              ...
              <div class="response_msg" id="resultlist_response_msg">