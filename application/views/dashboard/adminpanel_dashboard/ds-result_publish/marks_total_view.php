  ...
  .error-border{
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Marks Total</li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="box-header">
              <h3 class="box-title">Class wise marks total</h3>
                <a href="<?php echo base_url();?>publishresult/resultlist" class="link_tab"><span class="glyphicon glyphicon-plus"></span>Result List Upload</a>
            ...
            <div class="box-body">
                ...
                <?php
              $attr = array("id"=>"ResultListForm","name"=>"ResultListForm");
              echo form_open('',$attr); ?>
              <div class="row">
            ...
            <p id="clssubcreatmsg" class="form_error"></p>
              ...
              <button type="submit" class="btn btn-primary formBtn" >View Result List</button>
