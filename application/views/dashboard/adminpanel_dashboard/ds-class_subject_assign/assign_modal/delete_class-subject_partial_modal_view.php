          ...
          <tr>
            ...
            <td>
               <div id="sel_subfmarkserr_<?php echo $row?>">
               	...
               	<input type="text" class="form-control" name="sel_fullmarks[]" id="sel_fullmarks_<?php echo $row?>" value="<?php echo $value->subject_full_marks; ?>" readonly />
           ...
           <td>
           	<button type="button" class="btn btn-sm btn-danger dltsubjectbtn" 
           	data-dismiss="modal"
