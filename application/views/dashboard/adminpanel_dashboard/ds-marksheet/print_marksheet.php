...
<head>
   ...
   #outerdiv{
    ...
    color: #0d5360;
    float: left;
    background-image: url("<?php echo base_url();?>application/web_assets/images/text.png");
                          ...
                          <table  width="95%" >
                            <thead>
                               ...
                               <tr  style="height:1.2cm;"> 
                                <th style="font-weight:bold;">Sign of H/M</th>
                                <th style="font-weight:bold;">Sign of Parents</th>
