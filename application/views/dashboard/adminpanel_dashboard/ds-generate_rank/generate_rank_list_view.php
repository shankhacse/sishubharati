<script src="<?php echo base_url(); ?>application/assets/js_scripts/adm_scripts/generaterank.js"></script> 
<link rel="stylesheet" href="<?php echo base_url();?>application/assets/css/admin_style.css" />     
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Generate rank of Students</li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="box-header">
              <h3 class="box-title">Generate rank for next session</h3>
            ...
            <div class="box-body">
                ...
                <?php
              $attr = array("id"=>"GenerateRankForm","name"=>"GenerateRankForm");
              echo form_open('',$attr); ?>
              <div class="row">
            ...
            <div class="col-md-4">
              ...
              <button type="submit" class="btn btn-primary" id="viewblocllist">Generate Rank</button>
              </div>
                 </div>
             <?php echo form_close(); ?>
