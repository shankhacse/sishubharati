...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>application/assets/sishubharati_theme/dist/css/skins/_all-skins.min.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url();?>application/assets/sishubharati_theme/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url();?>application/assets/sishubharati_theme/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo base_url();?>application/assets/sishubharati_theme/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css" />
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo base_url();?>application/assets/sishubharati_theme/bower_components/bootstrap-daterangepicker/daterangepicker.css" />
  

  
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="<?php echo base_url();?>application/assets/sishubharati_theme/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  
  <!-- iCheck for checkboxes and radio inputs
  <link rel="stylesheet" href="<?php echo base_url();?>application/assets/sishubharati_theme/plugins/iCheck/all.css">
   -->
  <!-- DataTables -->
...
<!-- Morris.js charts -->
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/bower_components/raphael/raphael.min.js"></script>
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
...
<!-- daterangepicker -->
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/bower_components/moment/min/moment.min.js"></script>
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>

<!-- Icheck -
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/plugins/iCheck/icheck.min.js"></script>
-->
<!-- FastClick -->
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/bower_components/fastclick/lib/fastclick.js"></script>


<!-- InputMask -->
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/plugins/input-mask/jquery.inputmask.js"></script>
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/plugins/input-mask/jquery.inputmask.date.extensions.js"></script>
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/plugins/input-mask/jquery.inputmask.extensions.js"></script>


<!-- AdminLTE App -->
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/dist/js/adminlte.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo base_url();?>application/assets/sishubharati_theme/dist/js/pages/dashboard.js"></script>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
               <ul class="menu">
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url();?>application/assets/sishubharati_theme/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url();?>application/assets/sishubharati_theme/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url();?>application/assets/sishubharati_theme/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>application/assets/sishubharati_theme/dist/img/admin.jpg" class="user-image" alt="User Image">
