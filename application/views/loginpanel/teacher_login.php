...
<body class="hold-transition login-page bimg2">
<div class="login-box">
  <div class="login-logo">
  
    <a href="<?php echo base_url();?>teacher/login"><b><span class="sishu_text">Sishubharati</span></b> 
      <span class="admin_text">Teacher</span></a>
  </div>
  <!-- /.login-logo -->
   ...
   <!-- <form action="<?php echo base_url()?>administratorpanel/verifyLogin" method="post"> -->
	...
	echo form_open('administratorpanel/verifyLogin',$attr); ?>
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control " placeholder="Teacher ID" name="username" id="username" autocomplete="off" required="true"/>
      ...
      <!--     <div class="checkbox icheck">
       ...
       <a href="<?php echo base_url();?>administratorpanel">Admin login</a>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" id="teacherloginBtn">Sign In</button>
