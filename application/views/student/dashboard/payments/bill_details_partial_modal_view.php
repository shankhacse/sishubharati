...
<button type="button" class="btn-xs btn-warning margin" style="float:right;"><?php echo "Bill No : ".$billno; ?></button>
     <table class="table table-bordered dataTables" style="border-collapse: collapse !important;margin-top:10px;">
              <thead>
                <th width="5%">SL</th>
